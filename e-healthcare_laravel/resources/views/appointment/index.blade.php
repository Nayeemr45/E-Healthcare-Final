        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="appointment-image-holder">
                    <figure>
                        <img src="{{asset('asset/img/background/appoinment.jpg')}}" alt="Appointment">
                    </figure>
                </div>                       
            </div>
        </div>                    
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{asset('asset/img/doctor2.jpg')}}" alt="doctor" class="img-responsive">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{asset('asset/img/doctor1.jpg')}}" alt="doctor" class="img-responsive">
                    <div class="contents text-center">
                        <h4>Dr. Marry Lou</h4>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos, aspernatur.</p>
                        <a href="#" class="btn btn-main">read more</a>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{asset('asset/img/doctor3.jpg')}}" alt="doctor" class="img-responsive">
                    <div class="contents text-center">
