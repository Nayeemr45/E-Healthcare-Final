            ...
            <div class="right-side">
                  <ul class="contact-info">
                        <li class="item">
                              ...
                              <br>
                              <a href="#">
                                    <span>info@ehealthcare.com</span>
                              </a>
                        </li>
                        <li class="item">
                              <div class="icon-box">
...
<div class="hero-slider">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-center">
                        ...
                        <p class="tag-text mb-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quos, odit perspiciatis! Aliquam eos molestiae inventore ducimus soluta omnis, ullam excepturi expedita maxime illo molestias rem qui, vitae quaerat quos veritatis.</p>
    ...
    <!-- Slider Item -->
    <div class="slider-item" style="background-image:url({{ asset('asset/img/slider/slider-bg-2.jpg')}});">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start-->
    ...
    <!-- Slider Item -->
    <div class="slider-item" style="background-image:url({{ asset('asset/img/slider/slider-bg-3.jpg')}})">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{ asset('asset/img/resource/1.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Orthopedics</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{ asset('asset/img/resource/2.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Diaginostic</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{ asset('asset/img/resource/3.png')}}" alt="">
										</a>
									</figure>
								</div>
								<h6>Psycology</h6>
						...
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="{{ asset('asset/img/resource/4.png')}}" alt="">
										</a>
									</figure>
								</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content">
                        <div class="service-box tab-pane fade in active row" id="dormitory">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{ asset('asset/img/services/service-one.jpg')}}" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                        ...
                        <div class="service-box tab-pane fade in" id="orthopedic">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{ asset('asset/img/services/service-two.jpg')}}" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="sonogram">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{ asset('asset/img/services/service-three.jpg')}}" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="x-ray">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{ asset('asset/img/services/service-four.jpg')}}" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                        ...
                        <div class="service-box tab-pane fade in" id="diagnostic">
                            <div class="col-md-6">
                                <img class="img-responsive" src="{{ asset('asset/img/services/service-five.jpg')}}" alt="service-image">
                            </div>
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
        ...
        <div class="row items-container clearfix">
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="{{ asset('asset/img/gallery/1.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="{{ asset('asset/img/gallery/2.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
            ...
            <div class="item">
                <div class="inner-box">
                    <div class="img_holder">
                        <a href="service.html">
                            <img src="{{ asset('asset/img/gallery/3.jpg')}}" alt="images" class="img-responsive">
                        </a>
                    </div>
                    <div class="image-content text-center">
                        <span>Better Service At Low Cost</span>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{ asset('asset/img/team/doctor-2.jpg')}}" alt="doctor" class="img-responsive">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{ asset('asset/img/team/doctor-lab-3.jpg')}}" alt="doctor" class="img-responsive">
                    <div class="contents text-center">
                        <h4>Dr. Marry Lou</h4>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos, aspernatur.</p>
                        <a href="#" class="btn btn-main">read more</a>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="team-member">
                    <img src="{{ asset('asset/img/team/event-2.jpg')}}" alt="doctor" class="img-responsive">
                    <div class="contents text-center">
...
<!--testimonial-section-->
<section class="testimonial-section" style="background: url({{ asset('asset/img/testimonials/1.jpg')}});">
    <div class="container">
        <div class="section-title text-center">
            <h3>What Our
        ...
        <div class="testimonial-carousel">
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{ asset('asset/img/testimonials/1.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>Adam Rose</h6>
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{ asset('asset/img/testimonials/2.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>David Warner</h6>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, at?</p>
            ...
            <div class="slide-item">
                <div class="inner-box text-center">
                    <div class="image-box">
                        <figure>
                            <img src="{{ asset('asset/img/testimonials/3.png')}}" alt="">
                        </figure>
                    </div>
                    <h6>Amy Adams</h6>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, at?</p>
